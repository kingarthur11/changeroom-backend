...
class CompanyRepository extends BaseRepository
{
    ...
    public function getCompany($company_id)
    {
        ...
        $company = $company->where('id', $company_id)->where('user_id', $user_auth->id)->with('service')->with('country')->first();
        if (empty($company)) {
            return ['status' => false, 'response_message' => 'Company not found', 'data' => 'Company not found'];
        }
    ...
    {
        $company = new Company();
        $company = $company->with('service')->orderBy('created_at', 'DESC');
    ...
    public function get_user_companies($request)
    {

        $user_auth = Auth::user();
        $company = new Company();
        $company = $company->where('user_id', $user_auth->id)->with('service')->with('country')->orderBy('created_at', 'DESC');
    ...
    public function deleteCompany($company_id)
    {
        ...
        return ['status' => true, 'response_message' => 'Company deleted successfully', 'data' => 'Company deleted successfully'];
    }
}
